...
- [x] Create directory structure (src/, specs/, shared/, ios/, scripts/, example/, __tests__/)
...
- [x] Created __tests__/SwitchboardVoice.test.ts (17 tests)
...
### ⏳ 5.5 Testing
- [ ] __tests__/SwitchboardVoice.test.ts
