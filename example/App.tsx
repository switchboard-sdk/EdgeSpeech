...
// Import credentials (create credentials.ts with your app credentials)
import { SWITCHBOARD_APP_ID, SWITCHBOARD_APP_SECRET } from './credentials';
...
function App(): React.JSX.Element {
  ...
  const handleConfigure = async () => {
    try {
      ...
      Alert.alert('Success', 'SwitchboardVoice configured successfully');
    } catch (error) {
        ...
        {!isConfigured && (
          <View style={styles.warningBox}>
            <Text style={styles.warningText}>
              Update credentials.ts with your Switchboard app credentials
            </Text>
          </View>
        )}
